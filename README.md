...
2. Install Raspberry Pi OS
    Install and configure the operating system on the Raspberry Pi.
3. Update the System
   Update all system packages and install Python and required libraries.
4. Install Project Dependencies
   Install OpenCV, TensorFlow, Flask, NumPy, and other required Python packages.
5. Set Up the Project
   Copy  the project files to the Raspberry Pi(using USB)
6. Configure the System
   Enable the camera, set up the microphone, and configure notification settings (SMS).
7. Run the Application
    Start the application to begin real-time monkey detection, alert generation, and automatic deterrence.
8. Test the System
    Verify that monkey detection, notifications, deterrent sounds, and live video streaming are functioning correctly.
9. Enable Auto-Start 
